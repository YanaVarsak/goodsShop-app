...
export const getPopularCategories = () => ({
  type: POPULAR_CATEGORIES_ACTIONS.GET_POPULAR_CATEGORIES,
});

export const getPopularCategoriesSuccess = (
...
export const fetchPopularCategories =
  () => async (dispatch: Dispatch<any>) => {
    ...
    new Api()
      .getDataPopularCategory()
      .then((data) => {
    
        dispatch(getPopularCategoriesSuccess(data));
      })
      .catch(() => dispatch(getPopularCategoriesFailure()));
  };
